...
import org.omnione.did.cas.v1.admin.service.AdminPasswordPolicyManagementService;
...
public class AdminPasswordPolicyManagementController {
    ...
    @ResponseBody
    public AdminPasswordPolicyDto registerAdminPasswordPolicy(@Valid @RequestBody RegisterAdminPasswordPolicyReqDto reqDto) {
