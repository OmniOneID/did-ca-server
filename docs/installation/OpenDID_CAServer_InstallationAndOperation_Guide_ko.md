...
## 1.1. 개요
본 문서는 CA(Certified App) Server의 설치 및 구동에 관한 가이드를 제공합니다. CAS 서버의 설치 과정, 설정 방법, 그리고 구동 절차를 단계별로 설명하여, 사용자가 이를 효율적으로 설치하고 운영할 수 있도록 안내합니다.
